...
public class ConsultaViewController implements Initializable {
    ...
    @FXML private TextField IntroducirMedicamento; // Corregido: asumimos que este es un TextField
    ...
    public void initialize(URL url, ResourceBundle rb) {
                ...
                return new ListCell<Cita>() {
                    ...
                    protected void updateItem(Cita cita, boolean empty) {
                        ...
                        if (empty || cita == null) {
                            ...
                            // Cita.getMascota().getNombre() asume que Cita tiene un método getMascota()
                ...
                return new ListCell<Consulta>() {
                    ...
                    protected void updateItem(Consulta consulta, boolean empty) {
                        ...
                        if (empty || consulta == null) {
                            ...
                            // Consulta.getCita().getIDCita() asume que Consulta tiene un método getCita()
        ...
        // Listener para la ListView de Citas (se eliminó la duplicación)
        ...
        // Listener para la ListView de Consultas (se eliminó la duplicación)
    ...
    public void BotonAceptar() {
        // Se eliminó la duplicación de la variable 'citaSeleccionada'
        ...
        if (motivo.isEmpty() || idTratamiento.isEmpty() || nombreTratamiento.isEmpty() || duracionTratamiento.isEmpty() || medicamentoTratamiento.isEmpty()) {
            mostrarAlerta(Alert.AlertType.ERROR, "Error de datos", "Todos los campos de la consulta son obligatorios.");
            return;
        }
